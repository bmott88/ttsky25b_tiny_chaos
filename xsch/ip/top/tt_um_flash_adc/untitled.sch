...
F {}
E {}
C {/home/bmott/ttsky25b_tiny_chaos/xsch/ip/encoder/encoder_3to8_.sym} 550 30 0 0 {name=x1}
...
C {devices/lab_pin.sym} 550 -70 1 0 {name=p33 sig_type=std_logic lab=vdd}
C {devices/lab_pin.sym} 550 130 3 0 {name=p34 sig_type=std_logic lab=vss}
